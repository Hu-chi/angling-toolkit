...
from angling.nn.activations import Activation
from angling.nn.util import get_combined_dim, combine_tensors_and_multiply
...
class LinearAttention(Attention):
    ...
    def __init__(self, tensor_1_dim: int, tensor_2_dim: int, combination: str = "x,y", activation: Activation = None,
