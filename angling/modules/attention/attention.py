...
from angling.nn.util import masked_softmax


class Attention(torch.nn.Module):
    """
    An `1D Attention` takes two inputs: a (batched) vector and a matrix, plus an optional mask on the
    ...
    reference: <https://arxiv.org/pdf/1811.05544.pdf>
    ...
    @overrides
    def forward(self, vector: torch.Tensor, matrix: torch.Tensor, matrix_mask: torch.BoolTensor = None) -> torch.Tensor:
