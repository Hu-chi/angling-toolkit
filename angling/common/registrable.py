"""
adapted from `allennlp.common.registrable.Registrable`
"""
import importlib
import logging
...
class Registrable:
    ...
    def resolve_class_name(cls: Type[T], name: str) -> Tuple[Type[T], Optional[str]]:
        ...
        if name in Registrable._registry[cls]:
            ...
            try:
                ...
                message = f"tried to interpret {name} as a path to a class " \
            ...
            message = f"{name} is not a registered name for {cls.__name__}. " \
    ...
    def list_available(cls) -> List[str]:
        ...
        if default is None:
            ...
            logger.error(f"Default implementation {default} is not registered")
